#!/bin/bash -xe
# This script is for deleting an Elastic Kubernetes Service (EKS) cluster
...
# Delete the EKS cluster via configuration file
eksctl delete cluster -f "${DIR}/../infrastructure/eks/eksctl-cluster.yaml"
